...
export class InstitucionService {
  ...
  public EditarInstitucion(idInstitucion: string, institucion: {nombre: string, direccion: string, telefono: string, ciudad: string }): Observable<any> {
    return this.http.put<any>(this.hostUrl + `/Instituciones/EditarInstitucion/${idInstitucion}`, institucion);
  }

  public EliminarInstitucion(idInstitucion: string): Observable<any> {
